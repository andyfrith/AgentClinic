          ...
          <>
            ...
            <div>
              ...
              <input
                ...
                className="w-full mt-1 px-3 py-2 rounded-md border text-sm"
                value={f.avatar}
                onChange={(e) => onChange({ ...f, avatar: e.target.value })}
              />
            </div>
            <div>
              ...
              <input
                ...
                className="w-full mt-1 px-3 py-2 rounded-md border text-sm"
                value={f.specialty}
                onChange={(e) => onChange({ ...f, specialty: e.target.value })}
              />
            </div>
            <div>
              ...
              <select
                ...
                className="w-full mt-1 px-3 py-2 rounded-md border text-sm"
                value={f.status}
                onChange={(e) => onChange({ ...f, status: e.target.value })}
              >
            ...
            <div>
              ...
              <textarea
                ...
                value={f.bio}
                onChange={(e) => onChange({ ...f, bio: e.target.value })}
              />
            </div>
          </>
        );
